	...
	<div class="container">
		<div class="row titular">
			<div class="col-lg-12"><h1>Cupos Confirmados: Salvador de Bahía</h1></div>
		</div>

		<div class="row DescProd">
			<div class="DescProdCaja col-xs-12 col-sm-4 col-lg-4">
				<div class="backgroundCaja">
					<img src="img/costaSauipe.jpg"/>
					<div style="height:<?=$alto?>">
						<h2>Costa do Sauipe</h2>
						<p class="destacar">Ideal Familias</p>
						<p>Adultos <strong>USD</strong> <span class="precio">2282</span></p>
			...
			<div class="DescProdCaja col-xs-12 col-sm-4 col-lg-4">
				<div class="backgroundCaja">
					...
					<div style="height:<?=$alto?>">	
						<h2>Iberostar Bahía</h2>
						<p class="destacar">Ideal Parejas</p>
			...
			<div class="DescProdCaja col-xs-12 col-sm-4 col-lg-4">
				<div class="backgroundCaja">
					...
					<div style="height:<?=$alto?>">
						<h2>Imbassai</h2>
						<p class="destacar">Ideal Familias</p>
						<p>Adultos <strong>USD</strong><span class="precio">2428</span></p>
						<p>1° Niño <strong>USD</strong><span class="precio"> 760</span></p>
